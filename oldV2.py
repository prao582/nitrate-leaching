...
def plot_pressure_model():
    ...
    #t, P = improved_euler_pressure(ode_model_pressure_no_mar, t0 = 1980, t1 = 2019, dt = 0.1, p0 = 0.5, pars = [0.05, 0.1])
...
def plot_concentration_model():
    ...
    t, C = improved_euler_concentration(ode_model_concentration_with_sink, t0 = 1980, t1 = 2019, dt = 0.1, C0 = 0.2, tdelay = 2, pars = [1e9, 5e4, 6.50424868e-01 , 7.35181289e-01, -3.39986410e+04, 1e5, 0, -0.03466])
    plt.plot(t, C)
    plt.show()
